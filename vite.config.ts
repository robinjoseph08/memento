...
// This adds pages served from this machine or a private network address, and
// still refuses arbitrary websites.
const privateNetworkOrigin = new RegExp(
  `^http://(${machine.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")}(\\.local)?|10(\\.\\d+){3}|192\\.168(\\.\\d+){2}|172\\.(1[6-9]|2\\d|3[01])(\\.\\d+){2})(:\\d+)?$`,
);
...
export default defineConfig({
  ...
  server: {
    ...
    cors: { origin: [defaultAllowedOrigins, privateNetworkOrigin] },
    host: true,
