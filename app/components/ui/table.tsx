...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full min-w-0 overflow-x-auto rounded-md border border-border"
    >
      <table
        data-slot="table"
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "px-4 py-3 text-left align-middle text-xs font-medium whitespace-nowrap text-muted",
        className,
      )}
      {...props}
    />
